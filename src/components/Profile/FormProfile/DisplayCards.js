...
const DisplayCards = ({
  ...
  return (
    <div className="flex flex-col -ml-3 mt-3 -mr-2">
      ...
      <p className="dark:text-primaryText-dark text-xs font-inter mt-1">
        You can add up-to 5 images
      </p>

      <div className="flex flex-row mt-3">
        <div className="relative border dark:border-chatDivider-dark px-6 py-5 rounded-xl cursor-pointer z-10">
        ...
        <div
          className="relative border dark:border-chatDivider-dark px-4 py-5 rounded-xl ml-4 cursor-pointer z-20"
