        ...
        {(provided) => (
          <div {...provided.droppableProps} ref={provided.innerRef}>
                ...
                {(provided) => (
                  ...
                  >
                    ...
                    <div className="flex-grow relative">
                      <input
                        ...
                        className="w-full pl-12 pr-2 pt-2.5 pb-2.5 -ml-2 placeholder:text-sm placeholder:font-light
                             placeholder:dark:text-primaryText-dark  rounded-3xl border font-normal dark:border-secondaryText-dark dark:bg-transparent
                    ...
                    {link.value && (
                      ...
                      >
                        <span className="text-xs font-light -ml-2 dark:text-secondaryText-dark">
                          X
                        </span>
                      </button>
                    )}
            ...
            <div className="flex flex-col mt-4 mb-2 ml-9">
              <span className="text-white text-sm font-inter font-light">
              ...
              <div className="flex items-center space-x-4 mt-1 mb-2">
                <div className="flex-grow relative">
                  <input
                    ...
                    className="w-full pl-12 pr-2  pt-2.5 pb-2.5 -ml-2 placeholder:text-sm placeholder:font-light placeholder:dark:text-primaryText-dark 
                            rounded-3xl border font-normal dark:border-secondaryText-dark dark:bg-transparent dark:text-secondaryText-dark focus:border-primary focus:ring-0 focus:outline-none"
                  />
                  <img
                    src={Others}
                    alt="Others"
