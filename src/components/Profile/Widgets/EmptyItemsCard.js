...
const EmptyItemsCard = () => {
  ...
  return (
    <div className="flex flex-col space-y-4 mt-4 w-full">
      <div className="dark:bg-tertiaryBackground-dark p-4 rounded-lg  xl:w-1/2 lg:w-3/4 w-full">
        <div className="flex sm:flex-row flex-col w-full">
          ...
          <div className="flex flex-col justify-between ml-4 xs:mt-0 mt-1">
            ...
            <button
              className="mt-4 border w-max dark:border-secondaryText-dark py-2 px-4
               rounded-lg dark:text-secondaryText-dark font-normal text-sm font-inter sm:mx-0 mx-auto"
      ...
      <div className="dark:bg-tertiaryBackground-dark p-4  rounded-lg items-end justify-end xl:w-1/2 lg:w-3/4 w-full ml-auto">
        <div className="flex sm:flex-row flex-col w-full">
          <img
