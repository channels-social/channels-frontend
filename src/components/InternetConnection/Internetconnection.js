    ...
    return (
      ...
      <div className="flex flex-row items-end justify-center bg-primaryBackground">
        <img
              ...
              className="w-2/5 -mb-8 text-white"
            />
        <div className="flex flex-col ml-14 items-start">
        <h1 className="text-center text-errorLight text-md font-extralight font-inter mb-1">#Internet</h1>
        ...
        is out of world
          ...
          <button className="mt-3 py-2.5 px-5 bg-primary text-buttonText text-sm rounded-full" onClick={navigateToHome}>
            Return Home
          </button>
          </div>
