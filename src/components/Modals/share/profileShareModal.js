    ...
    <Dialog.Root open={isOpen}>
      <Dialog.Portal>
        ...
        <div className="fixed inset-0 flex items-center justify-center z-50">
          <Dialog.Content
            className="dark:bg-secondaryBackground-dark rounded-xl overflow-hidden shadow-xl transform transition-all w-[90%] lg:w-1/3 sm:w-1/2 pt-5 pl-5 flex flex-col"
