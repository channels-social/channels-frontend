...
import { UnsubscribeProfile, fetchmySubscriptions } from './../../../redux/slices/homeSlice';
            ...
            <Dialog.Title></Dialog.Title>
              <div className="flex flex-col p-5">
                <div className="flex justify-between items-center mb-4">
                  <h2 className="text-white text-lg font-normal fonr-inter">Action Confirmation</h2>
                ...
                <div className="text-textFieldColor text-sm font-normal font-inter tracking-wide" style={{lineHeight:"1.5"}}>Are you sure you want to 
                    unsubscribe to {username}. Once you unsubscribe, you will stop receiving updates from them. You can go back to their
                    profile to subscribe again. </div>
                </div>
