...
const EditChipsReservedModal = ({
  ...
  const handleLocationExclusiveChange = (e) => {
    dispatch(
      setEditLocationField({ field: "exclusive", value: e.target.checked })
    );
  };
  ...
  const handleDocumentExclusiveChange = (e) => {
    dispatch(
      setEditDocumentField({ field: "exclusive", value: e.target.checked })
    );
  };
  const handleLinkExclusiveChange = (e) => {
    dispatch(
      setEditChipField({ field: "link_exclusive", value: e.target.checked })
    );
  };
  const handleTextExclusiveChange = (e) => {
    dispatch(
      setEditChipField({ field: "text_exclusive", value: e.target.checked })
    );
  };
